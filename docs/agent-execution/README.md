...
- [Evidence bundle records](machine/evidence-bundles/TASK-000011.no-claim.2026-07-18.json) and the current [2026-07-20 no-claim source-identity capture](machine/evidence-bundles/TASK-000011.no-claim.2026-07-20.json)
...
- [`TASK-000011`](machine/tasks/TASK-000011.json) implements the M0 reference portion of `WP-002` and binds explicitly to `work_packages: ["WP-002"]`: restart-safe process identity, generated capabilities and routes, bounded envelopes and queues, sequence validation, and kernel authorization. Its [review handoff](../research/task-000011-wp002-review-handoff-2026-07.md) maps candidate evidence and remaining evidence-bundle gaps. The historical checked no-claim [TASK-000011 evidence capture](machine/evidence-bundles/TASK-000011.no-claim.2026-07-18.json) and current [2026-07-20 source-identity capture](machine/evidence-bundles/TASK-000011.no-claim.2026-07-20.json), validated by [`validate_evidence_bundles.py`](../../tools/validate_evidence_bundles.py), bind candidate artifacts to exact source commits but record `needs_independent_review`. The task status is `review_pending`; the implementation agent cannot approve or merge it.
