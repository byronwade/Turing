...
| `PB-013` Benchmark/extreme-performance prep | partial | `RQ-16`, `RQ-23`, `RQ-34`, `RQ-35`, `RQ-37` | Sustained-performance policy comparison, then fixed-hardware browser runs with reproducible corpus, launch-runner and server lifecycle evidence, raw traces/artifacts, and statistics review. |
