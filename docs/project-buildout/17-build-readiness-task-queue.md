...
| `TASK-000002` Pinned toolchain and fresh-host bootstrap reproduction | `PB-008`, `PB-009`, `PB-020` | `WP-001` | The build foundation is ready for contained M0, but needs versioned compiler/SDK/linker/toolchain manifests, fresh-host reproduction, and owner-reviewed toolchain/fresh-host readiness before broader implementation confidence | Proposed only; checked no-claim ledger, inventory, run-record template, and readiness-review template exist |
...
| `TASK-000005` Browser-launch benchmark runner contract | `PB-013` | `WP-005`, `WP-018` | Chrome-class and extreme-performance goals need the [benchmark evidence and claim closure route](../research/benchmark-evidence-and-claim-closure-preparation-2026-07.md), raw no-claim equal-workload evidence infrastructure, no-real-profile browser-pin capture, and local competitor-version pins before any result | Proposed only |
| `TASK-000006` Native shell adapter bake-off | `PB-003`, `PB-004`, `PB-005`, `PB-014`, `PB-015` | `WP-004` | Toolkit-neutral shell work can proceed only through the [Native UI and Accessibility Closure Preparation](../research/native-ui-and-accessibility-closure-preparation-2026-07.md), with the checked no-claim adapter contract, framework bake-off, component, page-surface composition, window/input/accessibility inventories, native UI readiness-review template, equivalent adapter scope, accessibility evidence, and no webview runtime in trusted chrome | Proposed only; checked inventories and no-claim review template exist |
| `TASK-000007` Profile, Space, session, snapshot, and migration schemas | `PB-016` | `WP-004`, `WP-014`, `WP-017` | Session and migration formats need the synthetic-fixture schema, migration/fault, privacy-isolation, recovery-accounting, and owner-review sequence in the [profile/session execution and data-safety closure-preparation report](../research/profile-session-execution-and-data-safety-closure-preparation-2026-07.md) before real profile data exists | Proposed execution only; checked no-claim inventory, lifecycle decision preparation, execution/data-safety closure route, schema-package template, and readiness-review template exist |
| `TASK-000008` Backup ownership closure | `PB-019`, `PB-020` | Program control | The project cannot claim broad readiness while build-critical scopes have no qualified backup owners; use the [backup-ownership execution and two-person-control closure route](../research/backup-ownership-execution-and-two-person-control-closure-preparation-2026-07.md) before a reviewed manifest | Proposed only; checked blocked inventory, ownership decision preparation, execution/two-person-control closure route, qualification template, and readiness-review template exist |
| `TASK-000009` Research package identity and updater lab | `PB-017` | `WP-017` | Research packages and update metadata need the fake-key/local-only identity, metadata, install-fault, rollback/migration, privacy-event, and review sequence in the [package/update execution and release-safety closure route](../research/package-update-execution-and-release-safety-closure-preparation-2026-07.md) before updater work is trusted | Proposed execution only; checked no-claim inventory, update-lab package template, readiness-review template, and closure route exist |
| `TASK-000010` Security incident and patch rehearsal | `PB-018` | `WP-017` | Private intake, emergency patch, disclosure, cleanup, and role separation need the synthetic rehearsal and review sequence in the [incident-response execution and disclosure closure route](../research/incident-response-execution-and-disclosure-closure-preparation-2026-07.md) before developer preview, beta, stable, or supported-security claims | Proposed execution only; checked no-claim inventory, incident patch rehearsal template, readiness-review template, and closure route exist |

## Intake Snapshot

### Closure-preparation route index

Before a proposed task is converted into a reviewed immutable manifest, use the matching no-claim closure-preparation report to define the evidence packet and rejection rules: [ADR-0009/source strategy](../research/adr-0009-source-strategy-closure-preparation-2026-07.md), [toolchain/fresh host](../research/fresh-host-toolchain-reproduction-closure-preparation-2026-07.md), [IPC](../research/ipc-transport-and-authority-closure-preparation-2026-07.md), [sandbox](../research/sandbox-probe-execution-and-containment-closure-preparation-2026-07.md), [benchmark](../research/benchmark-evidence-and-claim-closure-preparation-2026-07.md), [native UI/accessibility](../research/native-ui-and-accessibility-closure-preparation-2026-07.md), [profile/session](../research/profile-session-execution-and-data-safety-closure-preparation-2026-07.md), [package/update](../research/package-update-execution-and-release-safety-closure-preparation-2026-07.md), [incident response](../research/incident-response-execution-and-disclosure-closure-preparation-2026-07.md), [backup ownership](../research/backup-ownership-execution-and-two-person-control-closure-preparation-2026-07.md), and final [PB-020 closure/owner decision](../research/build-readiness-closure-and-owner-decision-preparation-2026-07.md). These reports are planning handoffs only; they do not approve tasks, readiness, or production claims.
...
`TASK-000002` Pinned toolchain and fresh-host bootstrap reproduction:

- Start only from the checked [Build Information Readiness Ledger](../research/build-information-readiness-ledger-2026-07.md), [Fresh Host Reproduction Inventory](../research/fresh-host-reproduction-inventory-2026-07.md), [Fresh-Host Toolchain Reproduction Closure Preparation](../research/fresh-host-toolchain-reproduction-closure-preparation-2026-07.md), checked [run-record template](machine/fresh-host-runs/no-claim-run-record-template.json), and checked no-claim [fresh-host readiness-review template](machine/fresh-host-readiness-reviews/no-claim-fresh-host-readiness-template.json) with an explicitly classified independent fresh reference host or owner-approved clean-VM equivalent.
- Proves progress with versioned compiler, SDK, linker, Rust, Cargo, Git, and shell manifests plus dated bootstrap, doctor, check, and `xtask` output, exact OS, cache, target-directory, temp-directory, source-tree cleanliness, retained-log, failure-classification, rollback-note, and owner-reviewed toolchain/fresh-host readiness beyond the checked no-claim template.
...
- Reject if the checked no-claim fresh-host readiness-review template is cited as owner-reviewed toolchain or fresh-host readiness, `PB-008` or `PB-009` readiness, release confidence, production readiness, implementation, or Chrome-class evidence.
- Must not promote `PB-008` or `PB-009` to ready without independent toolchain/reproduction evidence and owner-reviewed readiness beyond the checked no-claim template.
...
- Nova-specific handoff is governed by the [Nova Native Build Entry Criteria](../research/nova-native-build-entry-criteria-2026-07.md), [Nova surface-contract map](../ui-runtime/design-lab/surface-contract-map.md), and validated [design-source manifest](../ui-runtime/machine/design-source-manifest.json). These remain visual/layout inputs only; the JSX source cannot become trusted runtime behavior, toolkit authority, or implementation approval.
...
- Proves progress with the checked no-claim [Profile Session Format Inventory](../research/profile-session-format-inventory-2026-07.md), [profile/session execution and data-safety closure-preparation report](../research/profile-session-execution-and-data-safety-closure-preparation-2026-07.md), checked no-claim [schema-package template](../storage/machine/profile-session-schema-packages/no-claim-profile-session-schema-template.json), and checked no-claim [readiness-review template](../storage/machine/profile-session-readiness-reviews/no-claim-profile-session-readiness-template.json), then a synthetic-fixture executable harness for versioned profile, Space, session, snapshot, and migration schema proposals, migration/fault/recovery accounting, privacy isolation, and owner-reviewed profile/session readiness beyond the template covering disk-full, power-loss, corruption, downgrade, export, deletion, private-session, crash-recovery, protected-work, privacy, and data-loss behavior.
