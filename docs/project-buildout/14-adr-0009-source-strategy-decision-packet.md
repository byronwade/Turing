...
Result: generated-output and first-party build-script evidence is sharper, but still not sufficient for adoption. Turing still needs clean-target generation, independent-host comparison, full build-script and proc-macro side-effect review, source-to-output license/provenance mapping, native artifact packaging review, and a policy for environment-sensitive build inputs.
...
| Dependency inventory | normal, build, dev, optional, native, generated, unsafe, JIT, media, GPU, network, storage, and platform dependencies, including block-level unsafe review, clean generated-output regeneration, accepted build-script/proc-macro side-effect policy, dynamic tracing, and generated-output provenance for any candidate component | selective component or release-code use |
