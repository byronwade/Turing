...
## 1) Build decision snapshot (as of 2026-07-20)
...
| `PB-013` (benchmark/Chrome-class prep) | **documented_no_runner** | `../benchmark-lab/chrome-class-performance-readiness-lane.md`, `research/performance-benchmark-readiness-packet-2026-07.md`, `research/benchmark-evidence-and-claim-closure-preparation-2026-07.md`, benchmark manifest/network profile/tool contracts, and browser pin/sample validators |
...
| `PB-013` Benchmark/Chrome-class prep | **documented_no_runner** | `benchmark-lab/chrome-class-performance-readiness-lane.md`, `research/performance-benchmark-readiness-packet-2026-07.md`, `research/benchmark-evidence-and-claim-closure-preparation-2026-07.md`, checked no-claim `research/machine/browser-engine-landscape-source-manifest.json`, benchmark harness manifests/contracts | Advance through L0 self-tests, L1 browser-run diagnostics, L2 equal-workload competitor diagnostics, and L3 owner-reviewed claim candidates with reproducible corpus, traces/artifacts, statistics, failure denominators, and expiry controls. |
