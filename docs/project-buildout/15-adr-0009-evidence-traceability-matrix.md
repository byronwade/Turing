...
| `ADR9-EV-007` | Generated-output determinism and provenance | Partial | [build-script/generated-output audit](../research/servo-build-script-generated-output-audit-2026-07.md) | clean-target regeneration diff, independent-host comparison, generator manifest, source-to-output license/provenance mapping | engine, supply-chain, quality |
