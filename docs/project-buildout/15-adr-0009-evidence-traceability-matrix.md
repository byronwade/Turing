...
| `ADR9-EV-007` | Generated-output determinism and provenance | Partial | [build-script/generated-output audit](../research/servo-build-script-generated-output-audit-2026-07.md); [clean generated-output reproduction probe](../research/servo-clean-generated-output-reproduction-2026-07.md); [generated-output generator manifest](../research/servo-generated-output-generator-manifest-2026-07.md) | feature-correct full clean-target regeneration diff beyond the package-scoped dummy-media probe, independent-host comparison, owner-reviewed generator manifest tied to selected baseline/profile/output families/generator versions/environment policy, source-to-output license/provenance mapping | engine, supply-chain, quality |
