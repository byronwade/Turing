...
This document does not approve Servo, Stylo, WebRender, SpiderMonkey, GStreamer, moztools, `servo-build-deps`, or any transitive dependency for Turing release code. It does not authorize copying Servo source into this repository. The short [ADR-0009 source-strategy closure preparation](../research/adr-0009-source-strategy-closure-preparation-2026-07.md) is the continuation route, while the machine source of truth for readiness status remains [`pre-build-readiness.json`](../blueprint-v1/machine/pre-build-readiness.json); the executable `ADR9-EV-*` status companion is [`adr-0009-evidence.json`](../blueprint-v1/machine/adr-0009-evidence.json); the narrative packet remains [ADR-0009 Source Strategy Decision Packet](14-adr-0009-source-strategy-decision-packet.md); final owner closure also routes through the [PB-020 owner-decision closure board](23-owner-decision-closure-board.md).
...
|---|---|---|---|---|---|
| `ADR9-EV-001` | Source identity and checkout trust | Partial | second Windows preflight; [source/archive provenance audit](../research/servo-source-archive-provenance-audit-2026-07.md); [upstream source provenance report](../research/servo-upstream-source-provenance-2026-07.md); [independent source verification](../research/servo-independent-source-verification-2026-07.md); [source-baseline equivalence policy prep](../research/servo-source-baseline-equivalence-policy-2026-07.md); [upstream refresh and source-strategy delta](../research/servo-upstream-refresh-and-source-strategy-delta-2026-07.md); [ADR-0009 provenance policy boundary](../research/adr-0009-source-strategy-closure-preparation-2026-07.md) | owner-selected source baseline, explicit signed-tag/signed-commit/equivalent provenance policy, owner-accepted equivalence policy, full blob/legal review for the selected baseline, rerun plan if selected baseline differs from the current build baseline | architecture, supply-chain |
| `ADR9-EV-002` | Reference build reproduction | Partial | second Windows preflight; bootstrap and build logs outside repo; [source strategy inventory](../research/servo-source-strategy-inventory-2026-07.md); [upstream refresh and source-strategy delta](../research/servo-upstream-refresh-and-source-strategy-delta-2026-07.md); [build reproduction evidence and replay-protocol draft](../research/servo-independent-build-reproduction-2026-07.md) | owner acceptance of the replay protocol, clean-target reproduction on an independent host or VM, target/cache isolation replay, success and failure log bundle | release-operations, quality |
...
| `ADR9-EV-007` | Generated-output determinism and provenance | Partial | [build-script/generated-output audit](../research/servo-build-script-generated-output-audit-2026-07.md); [clean generated-output reproduction probe](../research/servo-clean-generated-output-reproduction-2026-07.md); [generated-output generator manifest](../research/servo-generated-output-generator-manifest-2026-07.md); [source-to-output provenance map](../research/servo-generated-output-source-provenance-map-2026-07.md) | feature-correct full clean-target regeneration diff beyond the package-scoped dummy-media probe, independent-host comparison, owner-reviewed generator manifest tied to selected baseline/profile/output families/generator versions/environment policy, owner-reviewed source-to-output license/provenance approval tied to selected baseline/profile/component boundary | engine, supply-chain, quality |
...
| `docs/research/servo-generated-output-generator-manifest-2026-07.md` | `ADR9-EV-007` |
| `docs/research/servo-generated-output-source-provenance-map-2026-07.md` | `ADR9-EV-007` |
...
For `ADR9-EV-013`, the source record must also pin the WPT commit rather than relying on a moving branch, and must preserve the retrieval date, local patch or diff hash, manifest-generation inputs and output hash, selected include rules, and complete denominator. Test262 attribution and results remain separate from Turing-owned runtime evidence.
