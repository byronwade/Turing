...
- Research-route coverage is mechanically checked: all `37/37` active research questions have at least one `docs/research/` route, and all `213/213` crosswalk evidence paths resolve to existing repository files or directories.
