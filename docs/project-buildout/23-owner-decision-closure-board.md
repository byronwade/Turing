...
| `PB-020` build-readiness closure | Accept closure scope, remaining P0 decisions, readiness promotion, and any time-bounded exceptions | Real build-readiness closure review, synchronized gate evidence, independent review, and explicit exceptions with expiry and rollback | Keep `PB-020` partial until every remaining P0 owner decision is closed or has an approved exception |
