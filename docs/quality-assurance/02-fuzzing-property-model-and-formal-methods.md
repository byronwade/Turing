# Fuzzing, Property Tests, Model Tests, and Formal Methods
...
1. Prototype and measure coverage under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure grammars under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure structured mutation under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure invariants under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure state machines under representative, adversarial, failure, cancellation, and pressure conditions.
