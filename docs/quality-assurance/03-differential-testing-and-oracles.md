...
This chapter defines the research contract for **differential testing and oracles**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
- parser/runtime/layout/network/storage/accessibility comparison;
- disagreement classification;
- reduction;
- and no-majority correctness;
...
1. Prototype and measure multiple engines under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure normalized output under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure standard consultation under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure parser/runtime/layout/network/storage/accessibility comparison under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure disagreement classification under representative, adversarial, failure, cancellation, and pressure conditions.
