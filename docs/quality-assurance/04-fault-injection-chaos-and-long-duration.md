# Fault Injection, Chaos, and Long-Duration Testing
...
1. Prototype and measure process termination under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure IPC delay/drop under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure network faults under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure disk full/corruption under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure GPU reset under representative, adversarial, failure, cancellation, and pressure conditions.
