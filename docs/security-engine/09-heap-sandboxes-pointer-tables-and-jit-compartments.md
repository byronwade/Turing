# Heap Sandboxes, Pointer Tables, and JIT Compartments
...
1. Prototype and measure pointer compression under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure external pointer tables under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure cage boundaries under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure code/data separation under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure W^X under representative, adversarial, failure, cancellation, and pressure conditions.
