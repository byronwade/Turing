# Capability Provenance, Attenuation, and Revocation
...
1. Prototype and measure kernel-issued identities under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure derivation chains under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure scope under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure expiry under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure epochs under representative, adversarial, failure, cancellation, and pressure conditions.
