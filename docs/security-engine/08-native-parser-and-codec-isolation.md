# Native Parser and Codec Isolation

Status: detailed research and design baseline  
Owner: Browser security engineering  
Book index: [README](README.md)  
Canonical overview: [Blueprint owner](../blueprint-v1/08-security-and-sandbox.md)

## Purpose

This chapter defines the research contract for **native parser and codec isolation**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.

## Scope

The study covers:

- memory-unsafe libraries;
- utility processes;
- RLBox/Wasm-like compartments;
- SFI;
- capability imports;
- immutable outputs;
- copy cost;
...
1. Prototype and measure memory-unsafe libraries under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure utility processes under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure RLBox/Wasm-like compartments under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure SFI under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure capability imports under representative, adversarial, failure, cancellation, and pressure conditions.
