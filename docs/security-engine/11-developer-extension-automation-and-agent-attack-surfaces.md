# Developer, Extension, Automation, and Agent Attack Surfaces
...
1. Prototype and measure remote debugging under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure evaluation under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure normal profiles under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure extension worlds under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure native messaging under representative, adversarial, failure, cancellation, and pressure conditions.
