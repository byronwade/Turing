# Anti-Phishing, Reputation, Abuse Resistance, and Trusted UI
...
1. Prototype and measure origin display under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure IDN/lookalikes under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure permission fatigue under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure dangerous downloads under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure reputation providers under representative, adversarial, failure, cancellation, and pressure conditions.
