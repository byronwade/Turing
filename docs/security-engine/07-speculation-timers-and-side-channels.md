# Speculation, Timers, and Side Channels
...
This chapter defines the research contract for **speculation, timers, and side channels**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.

## Scope

The study covers:

- Spectre-class threats;
...
1. Prototype and measure Spectre-class threats under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure process/site isolation under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure cross-origin isolation under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure timer precision under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure shared resources under representative, adversarial, failure, cancellation, and pressure conditions.
