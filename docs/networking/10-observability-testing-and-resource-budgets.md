# Networking Observability, Testing, and Resource Budgets
...
- policy explanations;
- packet-independent diagnostics;
- hermetic servers;
- fault injection;
- fuzzing;
- connection/buffer budgets;
- wakeups;
...
1. Prototype and measure causal request traces under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure policy explanations under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure packet-independent diagnostics under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure hermetic servers under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure fault injection under representative, adversarial, failure, cancellation, and pressure conditions.
