...
This chapter defines the research contract for **http/1.1, http/2, http/3, and quic**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
1. Prototype and measure framing under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure compression under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure prioritization under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure multiplexing under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure connection coalescing under representative, adversarial, failure, cancellation, and pressure conditions.
