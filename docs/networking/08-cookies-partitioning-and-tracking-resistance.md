# Cookies, Partitioning, and Tracking Resistance
...
1. Prototype and measure cookie parsing under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure SameSite under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure prefixes under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure partitioned cookies under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure top-level-site keys under representative, adversarial, failure, cancellation, and pressure conditions.
