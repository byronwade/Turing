# Caching, Preload, Speculation, and Service Workers
...
1. Prototype and measure HTTP cache keys under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure validators under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure freshness under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure preload scanners under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure speculative work under representative, adversarial, failure, cancellation, and pressure conditions.
