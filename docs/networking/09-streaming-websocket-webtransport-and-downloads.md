# Streaming, WebSocket, WebTransport, and Downloads
...
1. Prototype and measure streaming bodies under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure upload/download backpressure under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure WebSocket under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure datagrams under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure WebTransport under representative, adversarial, failure, cancellation, and pressure conditions.
