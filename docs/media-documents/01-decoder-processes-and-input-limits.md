# Decoder Processes and Input Limits
...
This chapter defines the research contract for **decoder processes and input limits**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
- dimension/frame/duration limits;
- cancellation;
- isolated utilities;
- immutable outputs;
- fuzzing;
...
1. Prototype and measure format sniffing under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure metadata-before-allocation under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure dimension/frame/duration limits under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure cancellation under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure isolated utilities under representative, adversarial, failure, cancellation, and pressure conditions.
