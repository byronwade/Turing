# Audio/Video Clocks, Buffering, and Seeking
...
This chapter defines the research contract for **audio/video clocks, buffering, and seeking**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
1. Prototype and measure demux under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure decode under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure playback clocks under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure A/V synchronization under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure seeking under representative, adversarial, failure, cancellation, and pressure conditions.
