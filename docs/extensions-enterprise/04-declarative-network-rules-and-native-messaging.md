# Declarative Network Rules and Native Messaging
...
1. Prototype and measure bounded rules under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure precedence under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure privacy under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure performance under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure conflicts under representative, adversarial, failure, cancellation, and pressure conditions.
