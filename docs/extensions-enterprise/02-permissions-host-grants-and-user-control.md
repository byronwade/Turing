# Permissions, Host Grants, and User Control
...
This chapter defines the research contract for **permissions, host grants, and user control**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.

## Scope

The study covers:

- declared/optional permissions;
- site-specific host access;
- one-time grants;
- activeTab-like gestures;
- private-profile separation;
- review UI;
- revocation;
- and audit;
...
1. Prototype and measure declared/optional permissions under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure site-specific host access under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure one-time grants under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure activeTab-like gestures under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure private-profile separation under representative, adversarial, failure, cancellation, and pressure conditions.
