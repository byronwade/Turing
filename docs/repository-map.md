...
- [`docs/project-buildout/20-build-continuation-readiness-pack.md`](project-buildout/20-build-continuation-readiness-pack.md): compact continuation pack that summarizes no-claim gates and hard-stop boundaries;
