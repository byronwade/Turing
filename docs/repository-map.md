...
The checked no-claim [`ipc-wire-source-manifest.json`](blueprint-v1/machine/ipc-wire-source-manifest.json) and [`ipc-wire-source-manifest.schema.json`](blueprint-v1/machine/ipc-wire-source-manifest.schema.json) track official wire-format observations; [`validate_ipc_wire_sources.py`](../tools/validate_ipc_wire_sources.py) verifies the records without selecting an encoding, approving a generator, authenticating a transport, or proving production IPC.
