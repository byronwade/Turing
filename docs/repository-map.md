...
- `validate_fresh_host_toolchain_sources.py`: dependency-free validation for the checked no-claim PB-008/PB-009 Rustup override, Cargo, Microsoft compiler-environment, and Windows SDK source manifest, nine toolchain/fresh-host evidence axes, source-document links, and unsupported reproduction/readiness boundaries; it does not prove compiler/SDK/linker equivalence, independent reproduction, or implementation;
