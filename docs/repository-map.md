...
- `validate_specified_task_manifests.py`: dependency-free validation that specified `TASK-000001` through `TASK-000010` manifests match immutable queue scope, `PB-*` readiness mappings, budgets, rollback, dependencies, queue digest, and proposed/non-executable authority boundaries;
