...
- `validate_owner_decision_closure_board.py`: dependency-free validation that the owner-decision board contains the canonical unresolved gate rows, required no-claim wording, actionable evidence fields, local links, and pre-build/information-ledger coverage;
...
- [`tools/validate_owner_decision_closure_board.py`](../tools/validate_owner_decision_closure_board.py): checks the owner-decision board's canonical gate rows, no-claim wording, local links, and coverage against the pre-build and information-readiness registries;
