# Migrations, Corruption, Disk Full, and Power Loss
...
1. Prototype and measure transactional migrations under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure interruption under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure checksums under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure old/new version negotiation under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure downgrade protection under representative, adversarial, failure, cancellation, and pressure conditions.
