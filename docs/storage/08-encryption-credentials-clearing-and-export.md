# Encryption Boundaries, Credentials, Clearing, and Export
...
1. Prototype and measure OS key stores under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure envelope encryption under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure profile secrets under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure Clear-Site-Data under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure selective deletion under representative, adversarial, failure, cancellation, and pressure conditions.
