# Cache Storage, Service Workers, and Background Work
...
1. Prototype and measure cache request matching under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure service-worker registrations under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure update lifecycle under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure background tasks under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure partitioning under representative, adversarial, failure, cancellation, and pressure conditions.
