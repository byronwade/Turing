# Permissions, Credentials, Agents, and Trusted UX
...
1. Prototype and measure origin-bound prompts under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure active indicators under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure page info under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure passkeys under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure autofill under representative, adversarial, failure, cancellation, and pressure conditions.
