# Tabs, Groups, Workspaces, and the Command Field
...
- workspaces;
- bulk actions;
- URL/search/command distinction;
...
1. Prototype and measure horizontal/vertical tabs under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure search under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure recency under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure groups under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure workspaces under representative, adversarial, failure, cancellation, and pressure conditions.
