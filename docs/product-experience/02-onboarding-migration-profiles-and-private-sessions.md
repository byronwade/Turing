# Onboarding, Migration, Profiles, and Private Sessions
...
1. Prototype and measure first run under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure default browser under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure import under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure selective migration under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure profile identity under representative, adversarial, failure, cancellation, and pressure conditions.
