# IPC, Shared Memory, Serialization, and Batching
...
1. Prototype and measure message framing under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure copies under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure mappings under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure immutable buffers under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure validation under representative, adversarial, failure, cancellation, and pressure conditions.
