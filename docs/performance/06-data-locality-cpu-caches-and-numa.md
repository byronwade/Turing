# Data Locality, CPU Caches, and NUMA
...
This chapter defines the research contract for **data locality, cpu caches, and numa**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
1. Prototype and measure hot/cold field separation under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure structure-of-arrays versus array-of-structures under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure compact handles under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure pointer chasing under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure cache lines under representative, adversarial, failure, cancellation, and pressure conditions.
