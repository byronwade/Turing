# Causal Profiling and Regression Diagnosis
...
This chapter defines the research contract for **causal profiling and regression diagnosis**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
1. Prototype and measure stable event schemas under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure critical-path reconstruction under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure task causality under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure process clocks under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure queue wait under representative, adversarial, failure, cancellation, and pressure conditions.
