# PGO, LTO, Binary Layout, and Startup
...
This chapter defines the research contract for **pgo, lto, binary layout, and startup**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
1. Prototype and measure profile representativeness under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure thin/full LTO under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure code size under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure function ordering under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure hot/cold splitting under representative, adversarial, failure, cancellation, and pressure conditions.
