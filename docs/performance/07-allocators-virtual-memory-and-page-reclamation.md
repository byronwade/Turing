# Allocators, Virtual Memory, and Page Reclamation
...
- size classes;
- fragmentation;
- live/reserved/committed/resident pages;
- huge pages;
- guard pages;
...
1. Prototype and measure arenas under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure slabs under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure size classes under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure fragmentation under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure live/reserved/committed/resident pages under representative, adversarial, failure, cancellation, and pressure conditions.
