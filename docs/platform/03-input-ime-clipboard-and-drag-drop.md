# Input, IME, Clipboard, and Drag-and-Drop
...
This chapter defines the research contract for **input, ime, clipboard, and drag-and-drop**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
1. Prototype and measure keyboard under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure pointer under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure touch under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure pen under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure gestures under representative, adversarial, failure, cancellation, and pressure conditions.
