# Credentials, Notifications, and External Protocols
...
1. Prototype and measure credential brokers under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure passkeys under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure system notifications under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure file/device pickers under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure default browser registration under representative, adversarial, failure, cancellation, and pressure conditions.
