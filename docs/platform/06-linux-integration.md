...
This chapter defines the research contract for **linux integration**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.

## Scope

The study covers:

- Wayland/X11 transition;
- input methods;
- AT-SPI;
- portals;
- PipeWire;
...
1. Prototype and measure Wayland/X11 transition under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure input methods under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure AT-SPI under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure portals under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure PipeWire under representative, adversarial, failure, cancellation, and pressure conditions.
