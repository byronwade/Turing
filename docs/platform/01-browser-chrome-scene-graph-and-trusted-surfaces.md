# Browser Chrome Scene Graph and Trusted Surfaces
...
1. Prototype and measure retained UI artifacts under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure typography under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure controls under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure command model under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure hit testing under representative, adversarial, failure, cancellation, and pressure conditions.
