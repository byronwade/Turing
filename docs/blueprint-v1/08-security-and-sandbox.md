...
The checked [IPC Capability Boundary Inventory](../research/ipc-capability-boundary-inventory-2026-07.md), [WP-002 kernel identity and IPC reference](../research/wp-002-kernel-ipc-2026-07.md), [TASK-000011 WP-002 Review Handoff](../research/task-000011-wp002-review-handoff-2026-07.md), and checked no-claim [IPC schema-source template](machine/ipc-schema-sources/no-claim-control-envelope-template.json) are current `PB-011` planning and review-handoff evidence only. They make the M0 bounded-envelope, oversized-message, typed-identity, role-capability, process-capability record, generated-reference, and future schema-source handoff fields visible, while preserving missing proof for `TASK-000011` acceptance, evidence-bundle completion, wire encoding, connection authentication, stale-epoch receiver rejection on a real transport, timeout/cancellation behavior, malformed/reordered/wrong-principal transport tests, renderer security, agent security, process isolation, site isolation, and production IPC.
