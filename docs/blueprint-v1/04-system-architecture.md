...
The preferred encoding is generated from a compact internal schema with Rust types on both ends. Serialization libraries are evaluated for bounds behavior, zero-copy safety, forward compatibility, deterministic bytes where required, unknown-field/variant policy, generated-code provenance, and fuzzability. The current no-claim [IPC wire-encoding decision preparation](../research/ipc-wire-encoding-decision-prep-2026-07.md) compares candidate families without selecting one.
