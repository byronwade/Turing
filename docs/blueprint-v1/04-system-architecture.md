...
The portable authentication ordering is an invariant, not a transport-specific implementation detail:
...
Reconnect, restart, or endpoint replacement invalidates the affected channels, requests, capability handles, and leases. Operating-system ACLs, credentials, entitlements, and audit tokens are evidence inputs to this sequence, not authority by themselves.

The preferred encoding is generated from a compact internal schema with Rust types on both ends. Serialization libraries are evaluated for bounds behavior, zero-copy safety, forward compatibility, deterministic bytes where required, unknown-field/variant policy, generated-code provenance, and fuzzability. The current no-claim [IPC wire-encoding decision preparation](../research/ipc-wire-encoding-decision-prep-2026-07.md) and checked [IPC wire-source manifest](machine/ipc-wire-source-manifest.json), validated by [`validate_ipc_wire_sources.py`](../../tools/validate_ipc_wire_sources.py), compare candidate families without selecting one.

The current checked `PB-011` evidence is the [IPC Capability Boundary Inventory](../research/ipc-capability-boundary-inventory-2026-07.md), [WP-002 kernel identity and IPC reference](../research/wp-002-kernel-ipc-2026-07.md), [TASK-000011 WP-002 Review Handoff](../research/task-000011-wp002-review-handoff-2026-07.md), checked no-claim [TASK-000011 evidence capture](../agent-execution/machine/evidence-bundles/TASK-000011.no-claim.2026-07-18.json), the [`ipc-capability-boundary.json`](machine/ipc-capability-boundary.json) companion, and the checked no-claim [IPC schema-source template](machine/ipc-schema-sources/no-claim-control-envelope-template.json). It records M0 `ControlEnvelope`, typed identity, process-role, capability-model, process-capability, generated-reference, source-commit artifact-binding, and future schema-source handoff evidence, and it keeps the missing `TASK-000011` acceptance, accepted independent evidence-bundle instance, wire encoding decision, platform connection authentication, stale-epoch receiver proof on a real transport, timeout/cancellation behavior, fuzz/model tests, and malformed/reordered/wrong-principal transport coverage explicit. It is not an IPC wire-format decision, schema-generator approval for production use, owner-reviewed IPC readiness, or process-isolation proof.
