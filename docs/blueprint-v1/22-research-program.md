...
The checked no-claim [web-platform source manifest](../web-platform/machine/web-platform-source-manifest.json) is the source-identity companion for the active web-platform and compatibility research routes. It does not answer a research question, select a feature, or authorize implementation.
