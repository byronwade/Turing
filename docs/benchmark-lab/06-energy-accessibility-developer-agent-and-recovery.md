# Energy, Accessibility, Developer, Agent, and Recovery Workloads
...
1. Prototype and measure idle/wakeups under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure scrolling/video under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure screen-reader latency under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure DevTools overhead under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure automation under representative, adversarial, failure, cancellation, and pressure conditions.
