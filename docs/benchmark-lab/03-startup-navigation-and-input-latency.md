# Startup, Navigation, and Input Latency
...
This chapter defines the research contract for **startup, navigation, and input latency**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
- cold/warm launch;
- address-bar readiness;
- process start;
- session enumeration;
- request stages;
- useful content;
- input-to-event/render/present;
- p50/p95/p99;
...
1. Prototype and measure cold/warm launch under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure address-bar readiness under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure process start under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure session enumeration under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure request stages under representative, adversarial, failure, cancellation, and pressure conditions.
