# Frame Pacing, Raster, Composite, and GPU
...
This chapter defines the research contract for **frame pacing, raster, composite, and gpu**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
1. Prototype and measure 60-240 Hz under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure scroll/animation under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure main/compositor dependencies under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure damage under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure raster queues under representative, adversarial, failure, cancellation, and pressure conditions.
