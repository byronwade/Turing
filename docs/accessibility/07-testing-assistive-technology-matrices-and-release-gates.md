# Testing, Assistive-Technology Matrices, and Release Gates
...
1. Prototype and measure automated semantics under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure keyboard/focus under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure zoom under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure contrast under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure motion under representative, adversarial, failure, cancellation, and pressure conditions.
