# Names, Relations, Text Ranges, and Editing
...
This chapter defines the research contract for **names, relations, text ranges, and editing**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
1. Prototype and measure accessible-name computation under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure descriptions under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure labels under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure tables under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure text offsets under representative, adversarial, failure, cancellation, and pressure conditions.
