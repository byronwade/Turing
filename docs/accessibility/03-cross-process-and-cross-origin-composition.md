# Cross-Process and Cross-Origin Composition
...
This chapter defines the research contract for **cross-process and cross-origin composition**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.
...
1. Prototype and measure remote frame trees under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure stable node IDs under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure epochs under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure bounds under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure events under representative, adversarial, failure, cancellation, and pressure conditions.
