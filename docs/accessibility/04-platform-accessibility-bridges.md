...
1. Prototype and measure AX under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure UI Automation under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure AT-SPI under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure role/state mappings under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure actions under representative, adversarial, failure, cancellation, and pressure conditions.
