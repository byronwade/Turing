# Engine Semantics and Accessibility-Tree Generation
...
1. Prototype and measure roles under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure states under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure properties under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure relationships under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure hidden/inert policy under representative, adversarial, failure, cancellation, and pressure conditions.
