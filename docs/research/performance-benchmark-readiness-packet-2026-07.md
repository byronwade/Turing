...
- checked no-claim benchmark readiness-review template that ties hardware/OS controls, corpus/network controls, runner/artifact output, browser pins, statistics-analysis plan scope, statistics/denominator controls, claim-bundle review, and owner-reviewed benchmark readiness into one future review shape without approving benchmark-ready status or performance claims;
...
9. Replace the checked no-claim benchmark readiness-review template with an owner-reviewed benchmark readiness review after real hardware, corpus, runner, raw artifact, browser-pin, statistics-analysis plan, statistics, denominator, and claim-bundle evidence exists.
