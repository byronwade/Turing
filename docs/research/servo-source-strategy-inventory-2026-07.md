...
- Servo generated-output source-to-output provenance map, observed 2026-07-18: Servo/Stylo generator-family source and license signals, WebIDL corpus license marker counts, PLY/Mako/TOML/MarkupSafe license-signal observations, and remaining owner-reviewed source-to-output approval gaps from `C:\ts`
...
The [Servo Clean Generated-Output Reproduction Probe - July 2026](servo-clean-generated-output-reproduction-2026-07.md) narrows `ADR9-EV-007`. A default-media package-scoped clean-target attempt failed before Cargo output inspection because GStreamer was missing. A dummy-media package-scoped clean-target attempt emitted substantial `servo-script-bindings`, Stylo, GLSL, atom, zlib, and Khronos output under an isolated target, then failed in `mozjs_sys`; its `servo-script-bindings` output was smaller than the earlier warm full dev build. It does not prove a clean Servo build, generated-output determinism, source-to-output provenance, generated-code approval, or source approval.

The [Servo Generated-Output Generator Manifest - July 2026](servo-generated-output-generator-manifest-2026-07.md) further narrows `ADR9-EV-007`. It maps first-party Servo and pinned Stylo generator families, inputs, outputs, feature gates, retained output-family observations, and environment sensitivity. It changes the remaining gap from "generator manifest missing" to owner-reviewed generator manifest tied to selected baseline/profile/output families/generator versions/environment policy, plus feature-correct full clean regeneration, independent-host comparison, and source-to-output license/provenance review.

The [Servo Generated-Output Source-To-Output Provenance Map - July 2026](servo-generated-output-source-provenance-map-2026-07.md) adds a first-pass source/license/provenance map for the generated-output families identified by the manifest. It records Servo MPL root licensing, WHATWG BSD 3-Clause specification-portion terms, `servo-script-bindings` `MPL-2.0 AND BSD-3-Clause` package metadata, `556` WebIDL files with MPL markers, `9` WebIDL files with additional copyright-waiver standard-text markers, and Stylo CSS generator inputs including MIT Mako, MIT TOML, and BSD-style MarkupSafe signals. It changes the remaining gap from "source-to-output map missing" to owner-reviewed source-to-output license/provenance approval tied to a selected baseline/profile/component boundary.
