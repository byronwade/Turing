...
- the checked no-claim [Owner-Decision Synchronization Control](owner-decision-synchronization-control-2026-07.md) and [`owner-decision-synchronization.json`](../project-buildout/machine/owner-decision-synchronization.json).
