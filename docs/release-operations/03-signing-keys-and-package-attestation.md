# Signing Keys and Package Attestation
...
1. Prototype and measure hardware-backed keys under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure threshold control under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure role separation under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure short-lived credentials under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure audit under representative, adversarial, failure, cancellation, and pressure conditions.
