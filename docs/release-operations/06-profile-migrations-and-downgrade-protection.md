# Profile Migrations and Downgrade Protection
...
1. Prototype and measure schema versions under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure transactional migration under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure interruption under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure compatibility windows under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure backups under representative, adversarial, failure, cancellation, and pressure conditions.
