# Reproducible Builds, Provenance, and SBOM
...
This chapter defines the research contract for **reproducible builds, provenance, and sbom**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.

The checked no-claim [package/update source manifest](machine/package-update-source-manifest.json) records the official provenance and artifact-integrity observations relevant to this contract. It does not establish a reproducible build, package identity, signing result, or release readiness.

## Scope

The study covers:

- bit-for-bit or independently verifiable builds;
...
1. Prototype and measure bit-for-bit or independently verifiable builds under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure provenance attestations under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure dependency graphs under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure licenses under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure native blobs under representative, adversarial, failure, cancellation, and pressure conditions.
