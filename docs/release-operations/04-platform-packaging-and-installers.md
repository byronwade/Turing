# Platform Packaging and Installers
...
This chapter defines the research contract for **platform packaging and installers**. It is not an implementation or support claim. The design must remain compatible with the owning Blueprint, requirements, risks, security model, performance contract, accessibility obligations, and documentation policy.

## Scope

The study covers:

- macOS bundles/notarization;
- Windows installers/signing;
- Linux packages/sandboxes;
- permissions;
- paths;
- repair;
- uninstall;
...
1. Prototype and measure macOS bundles/notarization under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure Windows installers/signing under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure Linux packages/sandboxes under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure permissions under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure paths under representative, adversarial, failure, cancellation, and pressure conditions.
