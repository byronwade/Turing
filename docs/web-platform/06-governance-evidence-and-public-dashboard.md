# Governance Evidence and Public Dashboard
...
1. Prototype and measure support tables under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure exact revisions under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure WPT pass/fail/crash/timeout under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure unsupported features under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure standards positions under representative, adversarial, failure, cancellation, and pressure conditions.
