# Tests, Interoperability, and Dependency Graphs
...
1. Prototype and measure normative algorithms under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure WPT directories under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure prerequisites under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure failure denominator under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure Interop focus areas under representative, adversarial, failure, cancellation, and pressure conditions.
