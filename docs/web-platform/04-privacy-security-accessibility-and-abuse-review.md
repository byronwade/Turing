# Privacy, Security, Accessibility, and Abuse Review
...
1. Prototype and measure data flows under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure identifiers under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure permissions under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure fingerprinting under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure cross-origin effects under representative, adversarial, failure, cancellation, and pressure conditions.
