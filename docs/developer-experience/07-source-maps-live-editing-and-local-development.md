# Source Maps, Live Editing, and Local Development
...
1. Prototype and measure source-map fidelity under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure modules/workers/Wasm under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure workspace handles under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure local overrides under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure hot reload under representative, adversarial, failure, cancellation, and pressure conditions.
