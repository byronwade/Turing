# Deterministic Replay, Virtual Time, and State Capture
...
1. Prototype and measure time/randomness/network fixtures under representative, adversarial, failure, cancellation, and pressure conditions.
2. Prototype and measure input streams under representative, adversarial, failure, cancellation, and pressure conditions.
3. Prototype and measure navigation under representative, adversarial, failure, cancellation, and pressure conditions.
4. Prototype and measure task ordering under representative, adversarial, failure, cancellation, and pressure conditions.
5. Prototype and measure service workers under representative, adversarial, failure, cancellation, and pressure conditions.
