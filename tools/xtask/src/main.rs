...
fn check() -> Result<(), String> {
    ...
    command(
        &root,
        "python3",
        ["-B", "tools/validate_sandbox_platform_sources.py"],
    )?;
    command(
        &root,
        "python3",
    ...
    command(
        &root,
        "python3",
        ["-B", "tools/validate_ipc_wire_sources.py"],
    )?;
    command(
        &root,
        "python3",
        ["-B", "tools/validate_benchmark_sources.py"],
    )?;
    command(
        &root,
        "python3",
        ["-B", "tools/validate_accessibility_sources.py"],
    )?;
    command(
        &root,
        "python3",
        ["-B", "tools/validate_package_update_sources.py"],
    )?;
    command(
        &root,
        "python3",
        ["-B", "tools/validate_incident_response_sources.py"],
    )?;
    command(
        &root,
        "python3",
        ["-B", "tools/validate_ownership_control_sources.py"],
    )?;
    command(
        &root,
        "python3",
    ...
    command(
        &root,
        "python3",
        ["-B", "tools/validate_web_platform_sources.py"],
    )?;
    command(
        &root,
        "python3",
        ["-B", "tools/validate_source_manifest_metadata.py"],
    )?;
    command(
        &root,
        "python3",
    ...
    command(
        &root,
        "python3",
        ["-B", "tools/validate_owner_decision_synchronization.py"],
    )?;
    command(
        &root,
        "python3",
